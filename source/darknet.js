        ...
        for (let i = 0; i < sections.length; i++) {
            ...
            if (infer) {
                switch (section.type) {
                    ...
                    case 'depthwise_pointwise_convolutional': {
                        ...
                        layer.out_c = params.c;
                        layer.out = params.w * params.h * params.c;
                        layer.outputs[0].type = new darknet.TensorType('float32', make_shape([ params.w, params.h, params.c ], 'depthwise_pointwise_convolutional'));
                        break;
                    }
                    case 'detection': {
                        layer.out_w = params.w;
